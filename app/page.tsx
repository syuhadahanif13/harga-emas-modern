      ...
      <nav className="border-b">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <button className="px-5 py-2 text-sm border border-gray-300 rounded-full hover:bg-gray-50">
              Download
            </button>
            <a 
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-[#fff8e7] border border-[#f4d9b0] rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-2">
              <span>🇮🇩</span>
              <span className="font-semibold text-lg">IDR (Spot Dunia)</span>
            </div>
          ...
          <div className="bg-white border rounded-2xl p-6 flex flex-col">
            <div className="flex justify-between mb-3">
              ...
              <div className="text-xs text-right text-gray-500">Didukung oleh<br />Pluang</div>
            </div>

            <div className="flex-1 bg-gray-50 rounded-xl flex items-center justify-center text-gray-400 text-sm mb-4">
              [Chart Interaktif 5 Tahun]
            </div>

            <button className="w-full bg-[#2563eb] hover:bg-blue-700 text-white py-3 rounded-xl font-medium text-sm">
              Beli Emas di Pluang
            </button>
          </div>
        </div>

        {/* Antam & Pegadaian Side by Side */}
        ...
        <div className="mb-10">
          ...
          <div className="border border-[#f4d9b0] rounded-b-2xl p-4">
            <p className="text-sm text-gray-600">Tabel Jual & Beli UBS (mirip screenshot yang kamu kirim)</p>
          </div>
        </div>
